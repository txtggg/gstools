 ...
 * 	SqlTxUtil2 自动
 */
public abstract class SqlTxUtil2 {
	...
	/**************************************************** transaction ***************************************************/
	public synchronized SqlTxUtil2 beginTx() {
	...
	public synchronized SqlTxUtil2 rollBack() {
		if (!tx) {
	...
	public synchronized SqlTxUtil2 commitChange() {
		if (!tx) {
			throw new RuntimeException("事务尚未开启");
		}
		try {
	 ...
	 * @return
	 */
	public synchronized SqlTxUtil2 endTx() {
